...
from src.framework.math.matrix.vector.VectorFactory import Vector4
from src.framework.math.matrix.vector.VectorFactory import Vector6
from src.framework.math.matrix.vector.VectorFactory import VectorFactory
