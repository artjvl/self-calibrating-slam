...
#ifndef G2O_CONSTRAINT_POSES2D_SE2_V2_H
#define G2O_CONSTRAINT_POSES2D_SE2_V2_H
...
namespace g2o {
    class ConstraintPoses2DSE2V2 : public BaseFixedSizedEdge<3, SE2, NodeSE2, NodeSE2, ParameterV2> {
    public:
        ConstraintPoses2DSE2V2();
        void computeError() {
            NodeSE2* n1 = static_cast<NodeSE2*>(_vertices[0]);
            NodeSE2* n2 = static_cast<NodeSE2*>(_vertices[1]);
            ParameterV2* p = static_cast<ParameterV2*>(_vertices[2]);
...
#endif //G2O_CONSTRAINT_POSES2D_SE2_V2_H
